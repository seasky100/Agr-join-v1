...
public class SaveProfileProfessionalTitleAction extends ABaseAction {
    ...
    public SaveProfileProfessionalTitleAction(Context context, ABaseWebView webView) {
    ...
    protected void doAsynchHandle() {
        ...
        if (null != name && !"".equals(name)) {
            ...
            param.put("attName", UserInfor.SERVER_PROFESSIONALTITLE);
            ...
            try {
                ...
                if (resultBean != null && resultBean.getStatus() == cn.fundview.app.domain.webservice.util.Constants.REQUEST_SUCCESS) {
                    ...
                    userInfor.setProfessionalTitle(name);
                    userInfor.setId(uid);
