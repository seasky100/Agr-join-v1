 ...
 * 我能提供保存
 **/
public class SaveProfileLinkManAction extends ABaseAction {
    ...
    public SaveProfileLinkManAction(Context context, ABaseWebView webView) {
    ...
    protected void doAsynchHandle() {
        ...
        if (null != name && !"".equals(name)) {
            ...
            param.put("attName", UserInfor.SERVER_LINKMAN);
