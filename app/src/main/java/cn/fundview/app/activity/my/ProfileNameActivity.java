...
public class ProfileNameActivity extends ABaseActivity implements OptionMenuListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("editable", true)) {
            ...
            this.setCommonTitleBar("我的名字", R.id.webView, "保存", false);
        } else {

            this.setCommonTitleBar("我的名字", R.id.webView, null, false);
        }
    }
