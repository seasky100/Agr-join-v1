...
//    	this.local = this.driver + achvLogoPath;//需求图片的本地存储路径
...
ImgItem.prototype.init = function(){
	...
	this.view.bind("error", this.view, this.loadDefaultIcon);
...
//	}else{
//
//		this.view.attr("src", achvDefaultLogo);
//		this.loadIcon();
//	}
}
//
...
ImgItem.prototype.loadDefaultIcon = function(e) {

	var view = e.data;
	view.attr("src", achvDefaultLogo);
};
